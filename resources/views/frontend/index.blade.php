        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{asset('images/home-slider-image1.jpg')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h3>Your convenience is our first priority</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{asset('images/home-slider-image2.jpg')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h3>Instant quotes on your choice of any date</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{asset('images/home-slider-image3.jpg')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container py-4 px-lg-5">
        ...
        <div class="row text-center px-lg-5">
            <div class="col-sm-12 col-lg-4 ps-lg-5">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/furniture.jpg')}}'); background-size: 100% 100%;">
            ...
            <div class="col-sm-12 col-lg-4">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/large-items.jpg')}}');   background-size: 100% 100%;">
                    <div class="service-title">
            ...
            <div class="col-sm-12 col-lg-4 pe-lg-5">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/electric-appliances.png')}}');   background-size: 100% 100%;">
                    <div class="service-title">
        ...
        <div class="row text-center px-lg-5">
            <div class="col-sm-12 col-lg-4 ps-lg-5">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/car.jpg')}}');   background-size: 100% 100%;">
                    <div class="service-title">
                        <h3>Car Transport</h3>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-lg-4">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/parcel.jpg')}}');   background-size: 100% 100%;">
                    <div class="service-title">
            ...
            <div class="col-sm-12 col-lg-4 pe-lg-5">
                <div class="service-item" style="background: linear-gradient(rgba(0, 0, 0, 0.473), rgba(0, 0, 0, 0.473)), url('{{asset('images/motorbike.jpg')}}');   background-size: 100% 100%;">
                    <div class="service-title">
                ...
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item carousel-item active">
                            <div class="img-box mb-4"><img src="{{ asset('images/customer1.jpg') }}" alt=""></div>
                        ...
                        <div class="item carousel-item">
                            <div class="img-box mb-4"><img src="{{ asset('images/customer2.jpg') }}" alt=""></div>
